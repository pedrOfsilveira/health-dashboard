      ...
      if (anyEnabled) {
        ...
        if (!result.ok) {
          const messages = {
            ...
            sw_register_failed: 'Erro ao registrar o Service Worker. Recarregue a página e tente novamente.',
            error: 'Erro ao ativar notificações. Recarregue a página e tente novamente.',
          };
